...
describe('ToastProvider 组件', () => {
  ...
  it('success 调用后应显示绿色 Toast', async () => {
    ...
    await nextTick()
    const toastEl = wrapper.find('.bg-semi-success-light')
  ...
  it('error 调用后应显示红色 Toast', async () => {
    ...
    await nextTick()
    const toastEl = wrapper.find('.bg-semi-danger-light')
    expect(toastEl.exists()).toBe(true)
  ...
  it('info 调用后应显示蓝色 Toast', async () => {
    ...
    await nextTick()
    const toastEl = wrapper.find('.bg-semi-info-light')
    expect(toastEl.exists()).toBe(true)
  ...
  it('多个 Toast 可并存', async () => {
    ...
    await nextTick()
    const allToasts = wrapper.findAll('[class*="bg-semi-success-light"], [class*="bg-semi-danger-light"]')
